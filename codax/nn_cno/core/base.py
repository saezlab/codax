...
from .params import CNOConfig, CNOConfigParser
from codax.nn_cno.io.reactions import Reaction
from codax.nn_cno.datasets import cnodata
...
class CNOBase(Logging):
    ...
    def __init__(self, pknmodel, data, tag=None, verbose=False, use_cnodata=False, config=None):
        ...
        from codax.nn_cno.io import CNOGraph
        from codax.nn_cno.io import XMIDAS
        ...
        # I assume this should be a deep copy, otherwise the `link` attribute is lost.  
        self._model = deepcopy(self._pknmodel)

        # why another copy ?
        #self._cnograph = deepcopy(self._pknmodel)
